...
#
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/${GitUser}/schaya/main/accel.conf"
...
GitUser="syapik96"
#wget https://github.com/${GitUser}/
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/${GitUser}/schaya/main/tambah/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/${GitUser}/schaya/main/hapus/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/${GitUser}/schaya/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/${GitUser}/schaya/main/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/${GitUser}/schaya/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
