...
GitUser="syapik96"
wget https://raw.githubusercontent.com/${GitUser}/schaya/main/install/hanyassh.sh && chmod +x hanyassh.sh && screen -S hanyassh.sh ./hanyassh.sh
wget https://raw.githubusercontent.com/${GitUser}/schaya/main/websocketsshonly.sh && chmod +x websocketsshonly.sh && screen -S websocketsshonly.sh ./websocketsshonly.sh
