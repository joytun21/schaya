...
GitUser="syapik96"
cd /usr/local/sbin
wget -O ssssr "https://raw.githubusercontent.com/${GitUser}/schaya/main/menu-update/ssssr.sh" && chmod +x ssssr
wget -O addss "https://raw.githubusercontent.com/${GitUser}/schaya/main/tambah/addss.sh"
wget -O delss "https://raw.githubusercontent.com/${GitUser}/schaya/main/hapus/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/${GitUser}/schaya/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/${GitUser}/schaya/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/${GitUser}/schaya/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
