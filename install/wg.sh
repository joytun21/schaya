...
#wget https://github.com/${GitUser}/
cd /usr/local/sbin
wget -O wgr "https://raw.githubusercontent.com/${GitUser}/schaya/main/menu-update/wgr.sh" && chmod +x wgr
wget -O addwg "https://raw.githubusercontent.com/${GitUser}/schaya/main/tambah/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/${GitUser}/schaya/main/hapus/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/${GitUser}/schaya/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/${GitUser}/schaya/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/${GitUser}/schaya/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
