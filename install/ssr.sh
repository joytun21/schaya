...
# Install_SSR
cd /usr/local/sbin
wget -O /usr/bin/ssr "https://raw.githubusercontent.com/joytun21/schaya/main/menu-update/ssr.sh" && chmod +x /usr/bin/ssr
wget -O addssr "https://raw.githubusercontent.com/joytun21/schaya/main/tambah/addssr.sh" && chmod +x addssr
wget -O delssr "https://raw.githubusercontent.com/joytun21/schaya/main/hapus/delssr.sh" && chmod +x delssr
wget -O xp-ssr "https://raw.githubusercontent.com/joytun21/schaya/main/xp-ssr.sh" && chmod +x xp-ssr
wget -O renewssr "https://raw.githubusercontent.com/joytun21/schaya/main/renewssr.sh" && chmod +x renewssr
