...
echo -e  "  ║      COPYRIGHT ONEPIECEVPN, POWERED BY JOY VPN STORE.       ║" | lolcat
echo -e  "  ╚════════════════════════════════════════════════════════════╝" | lolcat
echo -e  "\e[1;31m"
...
case $system in
		...
		;;
		14)
		echo -e "\e[1;31m SORRY!!!! Still No Update , Sila semak repo https://github.com/joytun21/schaya masa kesemasa\e[0m "
		sleep 5
		clear
		system
		exit
