#!/bin/bash
# VPN Premium Script
# © Github.com/joystun21
# Orignal Repository: https://github.com/joytun21/schaya
# Modified By JoyVpnStore
...
echo -e  "  ╠════════════════════════════════════════════════════════════╣" | lolcat
echo -e  "  ║           Copyright © 2022 by Github.com/joytun21          ║" | lolcat
echo -e  "  ║            🔰Auto-Script is Powered by JOYVPN.🔰           ║" | lolcat
echo -e  "  ╚════════════════════════════════════════════════════════════╝" | lolcat
echo -e  "\e[1;31m"
